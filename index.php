...
<body id="index_body">
    ...
    <header class="header">
        <div class="header-logo">
            <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-bag-fill logo_svg" viewBox="0 0 16 16">
    ...
    <main id="index_main">
        ...
        <section class="catalog">
            ...
            ?>
                <div class="catalog_card" data-id="<?= $producto["id"] ?>"  data-nombre="<?= $producto["nombre"] ?>" data-precio="<?= $producto["precio"] ?>">
